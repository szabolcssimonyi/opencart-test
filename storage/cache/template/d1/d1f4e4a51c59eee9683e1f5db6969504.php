...
class __TwigTemplate_5dd95aeac0cf813bdf940875479123ec extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    \$.ajax({
        ...
        success: function(json) {
            ...
            \$(rows).each(function(index, item){
              if(\$(\"input[type='hidden'][oc-attribute='\"+item.value+\"'\").length===0){
                addAttributeWithData(item.value, item.label);
              }
            });
        }
    });
